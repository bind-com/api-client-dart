...
void main() {
  ...
  group(CryptoApi, () {
    ...
    //
    //Future<BuiltList<Candle>> getCryptoChartCandles(String asset, PeriodInterval interval, DateTime start, DateTime end, { bool showUsd }) async
    ...
    //
    //Future<BuiltList<ChartTick>> getCryptoChartLine(PeriodInterval interval, DateTime from, DateTime to, { bool showUsd }) async
