...
------------- | ------------- | -------------
[**getBeneficiaries**](ContactsApi.md#getbeneficiaries) | **GET** /beneficiaries/ | List of beneficiaries of current user
...
[**updateBeneficiary**](ContactsApi.md#updatebeneficiary) | **PATCH** /beneficiaries/{beneficiary_id}/ | Update beneficiary data (add/remove from favorite)
...
try {
    ...
    print('Exception when calling ContactsApi->getBeneficiaries: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ContactsApi->updateBeneficiary: $e\n');
}
```
