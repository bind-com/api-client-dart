...
class CryptoApi {
  ...
  Future<Response<BuiltList<MachineAndHumanReadables>>> getCryptoCandlePeriodIntervals({ 
    ...
    final _path = r'/charts/crypto/candle/intervals/';
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<MachineAndHumanReadables>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<MachineAndHumanReadables>>> getCryptoLinePeriodIntervals({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/charts/crypto/line/intervals/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<StakingChartTick>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<StakingChartTick>>> getStakingMainPoolChartLine({ 
    required PeriodInterval interval,
    required DateTime start,
    required DateTime end,
    num? pageSize,
    ...
    BuiltList<StakingChartTick> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(StakingChartTick)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<StakingChartTick>;
    ...
    return Response<BuiltList<StakingChartTick>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StakingMainPoolSize] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StakingMainPoolSize>> getStakingMainPoolSize({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/charts/staking/main_pool/size/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StakingMainPoolSize _responseData;

    try {
      const _responseType = FullType(StakingMainPoolSize);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as StakingMainPoolSize;
    ...
    return Response<StakingMainPoolSize>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
