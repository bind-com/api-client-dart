...
class CryptoWalletApi {
  ...
  Future<Response<void>> addCryptoFavorite({ 
    FavoriteCryptoCreateRequest? favoriteCryptoCreateRequest,
    ...
    final _path = r'/crypto/favorites/';
    ...
    try {
      const _type = FullType(FavoriteCryptoCreateRequest);
      _bodyData = favoriteCryptoCreateRequest == null ? null : _serializers.serialize(favoriteCryptoCreateRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteCryptoFavorite({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ChainImplementation>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ChainImplementation>>> getChainImplementations({ 
    required String assetId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/crypto/assets/{asset_id}/chain_implementations/'.replaceAll('{' r'asset_id' '}', assetId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ChainImplementation> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(ChainImplementation)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<ChainImplementation>;
    ...
    return Response<BuiltList<ChainImplementation>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CryptoAsset>>> getCryptoFavorites({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CryptoAccountLight>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CryptoAccountLight>>> getCryptoWalletLight({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/crypto/wallet/light/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<CryptoAccountLight> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(CryptoAccountLight)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<CryptoAccountLight>;
    ...
    return Response<BuiltList<CryptoAccountLight>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ProfitLoss>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ProfitLoss>>> getProfitLoss({ 
    required ProfitLossSort sorting,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/crypto/wallet/profitloss/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'sorting': encodeQueryParameter(_serializers, sorting, const FullType(ProfitLossSort)),
    };
    ...
    BuiltList<ProfitLoss> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(ProfitLoss)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<ProfitLoss>;
    ...
    return Response<BuiltList<ProfitLoss>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProfitLossSummary] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ProfitLossSummary>> getProfitLossSummary({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/crypto/wallet/profitloss/summary/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ProfitLossSummary _responseData;

    try {
      const _responseType = FullType(ProfitLossSummary);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<ProfitLossSummary>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SingleCryptoBalance] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SingleCryptoBalance>> getSingleCryptoBalance({ 
    ...
    final _path = r'/crypto/assets/{asset_id}/balance/'.replaceAll('{' r'asset_id' '}', assetId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SingleCryptoBalance _responseData;

    try {
      const _responseType = FullType(SingleCryptoBalance);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as SingleCryptoBalance;
    ...
    return Response<SingleCryptoBalance>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
