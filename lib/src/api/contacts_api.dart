...
class ContactsApi {
  ...
  Future<Response<Contact>> addContactByUser({ 
    AddContactByUserRequest? addContactByUserRequest,
    ...
    try {
      const _type = FullType(AddContactByUserRequest);
      _bodyData = addContactByUserRequest == null ? null : _serializers.serialize(addContactByUserRequest, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(Contact);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> checkContact({ 
    ...
    final _path = r'/contacts/{user_id}/check'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> createInnerFiatTransfer({ 
    ...
    try {
      const _type = FullType(FiatTransfer);
      _bodyData = fiatTransfer == null ? null : _serializers.serialize(fiatTransfer, specifiedType: _type);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JWTToken>> generateQRCodeToken({ 
    String? currency,
    num? amount,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    try {
      const _responseType = FullType(JWTToken);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as JWTToken;
  ...
  Future<Response<BuiltList<Contact>>> getContacts({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (lastTransactions != null) r'last_transactions': encodeQueryParameter(_serializers, lastTransactions, const FullType(bool)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InnerFiatTransferFeeResult] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InnerFiatTransferFeeResult>> getInnerFiatTransferFee({ 
    FiatTransfer? fiatTransfer,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    InnerFiatTransferFeeResult _responseData;

    try {
      const _responseType = FullType(InnerFiatTransferFeeResult);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as InnerFiatTransferFeeResult;
    ...
    return Response<InnerFiatTransferFeeResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<Uint8List>> qRCodeGenerateView({ 
    ...
    final _path = r'/users/generate/qr_code/';
    final _options = Options(
      method: r'GET',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserSharingData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserSharingData>> readJWTToken({ 
    JWTToken? jWTToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(JWTToken);
      _bodyData = jWTToken == null ? null : _serializers.serialize(jWTToken, specifiedType: _type);
    ...
    UserSharingData _responseData;

    try {
      const _responseType = FullType(UserSharingData);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UserSharingData;
    ...
    return Response<UserSharingData>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> updateContact({ 
    ...
    final _path = r'/contacts/{contact_id}/'.replaceAll('{' r'contact_id' '}', contactId.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = updateContactRequest == null ? null : _serializers.serialize(updateContactRequest, specifiedType: _type);
