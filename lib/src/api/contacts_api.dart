...
class ContactsApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SyncContacts200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SyncContacts200Response>> syncContacts({ 
    ...
    SyncContacts200Response _responseData;

    try {
      const _responseType = FullType(SyncContacts200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as SyncContacts200Response;
    ...
    return Response<SyncContacts200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
