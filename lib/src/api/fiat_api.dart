...
class FiatApi {
  ...
  const FiatApi(this._dio, this._serializers);
  ...
  Future<Response<void>> createFiatRequest({ 
    CreateFiatRequestRequest? createFiatRequestRequest,
    ...
    try {
      const _type = FullType(CreateFiatRequestRequest);
      _bodyData = createFiatRequestRequest == null ? null : _serializers.serialize(createFiatRequestRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> fiatSend({ 
    FiatSendRequest? fiatSendRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(FiatSendRequest);
      _bodyData = fiatSendRequest == null ? null : _serializers.serialize(fiatSendRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetFiatWallets200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetFiatWallets200Response>> getFiatWallets({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetFiatWallets200Response _responseData;

    try {
      const _responseType = FullType(GetFiatWallets200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetFiatWallets200Response;
    ...
    return Response<GetFiatWallets200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
