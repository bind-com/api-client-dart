...
class BeneficiariesApi {
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteBeneficiary({ 
  ...
  Future<Response<FiatTransferEstimate>> estimateFiatTransfer({ 
    ...
    final _path = r'/fiat/transfer/review/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FiatTransferEstimate _responseData;

    try {
      const _responseType = FullType(FiatTransferEstimate);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as FiatTransferEstimate;
    ...
    return Response<FiatTransferEstimate>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [beneficiaryId] - id of a beneficiary
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> updateBeneficiary({ 
    ...
    try {
      const _type = FullType(UpdateBeneficiaryRequest);
      _bodyData = updateBeneficiaryRequest == null ? null : _serializers.serialize(updateBeneficiaryRequest, specifiedType: _type);
