...
class UserApi {
  ...
  Future<Response<CheckKYCDocumentStatus200Response>> checkKYCDocumentStatus({ 
    ...
    CheckKYCDocumentStatus200Response _responseData;

    try {
      const _responseType = FullType(CheckKYCDocumentStatus200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as CheckKYCDocumentStatus200Response;
    ...
    return Response<CheckKYCDocumentStatus200Response>(
      data: _responseData,
  ...
  Future<Response<CheckKYCFileStatus200Response>> checkKYCFileStatus({ 
    ...
    final _path = r'/user/kyc/check_file/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [KYCRequestStatus] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<KYCRequestStatus>> checkKYCRequestApproval({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/kyc/requests/approval/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    KYCRequestStatus _responseData;

    try {
      const _responseType = FullType(KYCRequestStatus);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as KYCRequestStatus;
    ...
    return Response<KYCRequestStatus>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> checkKYCStatus({ 
    CheckKYCStatusRequest? checkKYCStatusRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CheckKYCStatusRequest);
      _bodyData = checkKYCStatusRequest == null ? null : _serializers.serialize(checkKYCStatusRequest, specifiedType: _type);
  ...
  Future<Response<bool>> checkPasscode({ 
    ...
    final _path = r'/users/check/passcode/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<CreateKYCFile200Response>> createKYCFile({ 
    ...
    final _path = r'/user/kyc/create_file/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    CreateKYCFile200Response _responseData;

    try {
      const _responseType = FullType(CreateKYCFile200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as CreateKYCFile200Response;
    ...
    return Response<CreateKYCFile200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> createKYCRequest({ 
    MultipartFile? selfie,
    MultipartFile? passportScan,
    MultipartFile? idScanFront,
    MultipartFile? idScanBack,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/user/kyc/requests/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        if (selfie != null) r'selfie': selfie,
        if (passportScan != null) r'passport_scan': passportScan,
        if (idScanFront != null) r'id_scan_front': idScanFront,
        if (idScanBack != null) r'id_scan_back': idScanBack,
      });
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetKYCDocumentUID200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetKYCDocumentUID200Response>> getKYCDocumentUID({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/user/kyc/document_uid/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetKYCDocumentUID200Response _responseData;

    try {
      const _responseType = FullType(GetKYCDocumentUID200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetKYCDocumentUID200Response;
    ...
    return Response<GetKYCDocumentUID200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Currency>> getUserPaymentCurrency({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/payment_currency/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [KYCRequestMoveResult] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<KYCRequestMoveResult>> moveKYCRequest({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    KYCRequestMoveResult _responseData;

    try {
      const _responseType = FullType(KYCRequestMoveResult);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as KYCRequestMoveResult;
    ...
    return Response<KYCRequestMoveResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<Uint8List>> qRCodeGenerateCustomString({ 
    ...
    try {
      const _type = FullType(QRCodeGenerateCustomStringRequest);
      _bodyData = qRCodeGenerateCustomStringRequest == null ? null : _serializers.serialize(qRCodeGenerateCustomStringRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<User>> updateUserPasscode({ 
    required String userID,
    UpdateUserPasscodeRequest? updateUserPasscodeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/users/change_passcode/{userID}/'.replaceAll('{' r'userID' '}', userID.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
