...
import 'package:bind_api/src/model/kyc_method_response.dart';
...
class UserApi {
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> createDevice({ 
    ...
    final _path = r'/users/firebase/device/';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = createDeviceRequest == null ? null : _serializers.serialize(createDeviceRequest, specifiedType: _type);
  ...
  Future<Response<void>> createKYCRequest({ 
    ...
    final _path = r'/user/old_kyc/requests/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> createRegistrationToken({ 
    CreateRegistrationTokenRequest? createRegistrationTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateRegistrationTokenRequest);
      _bodyData = createRegistrationTokenRequest == null ? null : _serializers.serialize(createRegistrationTokenRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteUserPhoto({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/photo/delete/';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [KYCMethodResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<KYCMethodResponse>> getKYCMethod({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    KYCMethodResponse _responseData;

    try {
      const _responseType = FullType(KYCMethodResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as KYCMethodResponse;
    ...
    return Response<KYCMethodResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Currency] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Currency>> getUserRefundCurrency({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/refund_currency/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
