...
class FiatWalletApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<BankCardBaseData>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<BankCardBaseData>>> getBankCardsList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<BankCardBaseData> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(BankCardBaseData)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<BuiltList<BankCardBaseData>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<FiatWalletLightWithPaymentCurrency>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<FiatWalletLightWithPaymentCurrency>>> getFiatWalletsWithUserPaymentCurrency({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<FiatWalletLightWithPaymentCurrency> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(FiatWalletLightWithPaymentCurrency)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<FiatWalletLightWithPaymentCurrency>;
    ...
    return Response<BuiltList<FiatWalletLightWithPaymentCurrency>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BankCardDetail>> lockBankCard({ 
    required String cardId,
    LockBankCardRequest? lockBankCardRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(LockBankCardRequest);
      _bodyData = lockBankCardRequest == null ? null : _serializers.serialize(lockBankCardRequest, specifiedType: _type);
