...
class FiatWalletApi {
  ...
  Future<Response<void>> changeCardBackground({ 
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        ...
        r'card_background': encodeFormParameter(_serializers, cardBackground, const FullType(String)),
      });
  ...
  /// Returns a [Future] containing a [Response] with a [BankCardDetail] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BankCardDetail>> changeCardStatus({ 
    required String cardId,
    ...
    final _path = r'/fiat/bankcards/{card_id}/card_status/'.replaceAll('{' r'card_id' '}', cardId.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ChangeCardStatusRequest);
      _bodyData = changeCardStatusRequest == null ? null : _serializers.serialize(changeCardStatusRequest, specifiedType: _type);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> createFiatWallet({ 
    CreateFiatWalletRequest? createFiatWalletRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateFiatWalletRequest);
      _bodyData = createFiatWalletRequest == null ? null : _serializers.serialize(createFiatWalletRequest, specifiedType: _type);
  ...
  /// Parameters:
  /// * [cardId] - id of exact card
  /// * [showEncryptedData] - Do we need to decrypt and show sensitive info about a card
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [BankCardDetail] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BankCardDetail>> getBankCard({ 
    required String cardId,
    required bool showEncryptedData,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/fiat/bankcards/{card_id}/'.replaceAll('{' r'card_id' '}', cardId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'show_encrypted_data': encodeQueryParameter(_serializers, showEncryptedData, const FullType(bool)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BankCardAnalytics] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BankCardAnalytics>> getBankCardAnalytics({ 
    required String cardId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/fiat/bankcards/{card_id}/analytics/'.replaceAll('{' r'card_id' '}', cardId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BankCardAnalytics _responseData;

    try {
      const _responseType = FullType(BankCardAnalytics);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BankCardAnalytics;
    ...
    return Response<BankCardAnalytics>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetBankCardsList200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetBankCardsList200Response>> getBankCardsList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetBankCardsList200Response _responseData;

    try {
      const _responseType = FullType(GetBankCardsList200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetBankCardsList200Response;
    ...
    return Response<GetBankCardsList200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CardView>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CardView>>> getCardBackgorundColor({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/fiat/bankcards/card_view/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<CardView> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(CardView)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<CardView>;
    ...
    return Response<BuiltList<CardView>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCardBenefits200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetCardBenefits200Response>> getCardBenefits({ 
    required String cardId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/fiat/bankcards/{card_id}/card_benefits/'.replaceAll('{' r'card_id' '}', cardId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetCardBenefits200Response _responseData;

    try {
      const _responseType = FullType(GetCardBenefits200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetCardBenefits200Response;
    ...
    return Response<GetCardBenefits200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCardLimits200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetCardLimits200Response>> getCardLimits({ 
    required String cardId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/fiat/bankcards/{card_id}/card_limits/'.replaceAll('{' r'card_id' '}', cardId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetCardLimits200Response _responseData;

    try {
      const _responseType = FullType(GetCardLimits200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetCardLimits200Response;
    ...
    return Response<GetCardLimits200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FiatAccount] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<FiatAccount>> getFiatAccount({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    FiatAccount _responseData;

    try {
      const _responseType = FullType(FiatAccount);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as FiatAccount;
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Currency>>> getFiatCurrencies({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CurrencyWithRate>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CurrencyWithRate>>> getFiatCurrenciesWithRates({ 
    ...
    final _path = r'/fiat/currencies/rate/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<CurrencyWithRate> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(CurrencyWithRate)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<CurrencyWithRate>;
    ...
    return Response<BuiltList<CurrencyWithRate>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<FiatWallet>> getFiatWalletDetails({ 
    ...
    final _path = r'/fiat/wallets/{wallet_id}/'.replaceAll('{' r'wallet_id' '}', walletId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> shareDefaultFiatWallet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/fiat/wallets/share/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> shareFiatWallet({ 
    required String walletId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/fiat/wallets/{wallet_id}/share/'.replaceAll('{' r'wallet_id' '}', walletId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BankCardDetail] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BankCardDetail>> updateBankCardSettings({ 
    required String cardId,
    ...
    try {
      const _type = FullType(BankCardSettings);
      _bodyData = bankCardSettings == null ? null : _serializers.serialize(bankCardSettings, specifiedType: _type);
