...
class TransactionsApi {
  ...
  Future<Response<Uint8List>> exportTransactions({ 
    TransactionExportFilter? transactionExportFilter,
    ...
    try {
      const _type = FullType(TransactionExportFilter);
      _bodyData = transactionExportFilter == null ? null : _serializers.serialize(transactionExportFilter, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Uint8List] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Uint8List>> exportTransactionsById({ 
    ...
    final _path = r'/transactions/export/history/{export_id}/'.replaceAll('{' r'export_id' '}', exportId.toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ExportHistory>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ExportHistory>>> getExportHistory({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<ExportHistory> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(ExportHistory)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<ExportHistory>;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<TransactionGroupsAndTypes>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<TransactionGroupsAndTypes>>> getTransactionTypesExportHistory({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/transactions/types/export_history';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<TransactionGroupsAndTypes> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(TransactionGroupsAndTypes)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<TransactionGroupsAndTypes>;
    ...
    return Response<BuiltList<TransactionGroupsAndTypes>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Currency>>> getTransactionsAssetsList({ 
    TransactionAssetsFilter? transactionAssetsFilter,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/transactions/assets/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TransactionAssetsFilter);
      _bodyData = transactionAssetsFilter == null ? null : _serializers.serialize(transactionAssetsFilter, specifiedType: _type);
